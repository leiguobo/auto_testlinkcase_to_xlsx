...
from testlink2metersphere.ConvertfileCore.ExcelTestSuite import ExcelTestSuite
from testlink2metersphere.ConvertfileCore.ExcelTestCase import ExcelTestCase
from testlink2metersphere.ConvertfileCore.ExcelTestStep import ExcelTestStep
from test_to_xlsx.last_xml import sortfile,path
xml_file_path_out=sortfile(path)
out_testsuite=[]
...
xml_file_path =os.path.abspath(os.path.join(xml_file_path_out))
...
for row,tc_item in enumerate(tc_list,1):
    # print(tc_item.testsuitename)
    a=tc_item.testsuitename
    out_testsuite.append(a)
# print(out_testsuite)
# print(len(out_testsuite))
